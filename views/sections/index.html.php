      ...
      <div class="item-inner Rale ">
        ...
        <div class="item-input-wrap sz1">
          ...
          <span class="input-clear-button"></span>
				...
				<div class="text-editor text-add-section text-editor-init" data-placeholder="Enter text..." data-buttons='[["bold", "italic", "underline", "strikeThrough"],["h1","h2","h3"],["alignLeft","alignRight","alignCenter","alignJustify"], ["subscript", "superscript"],
      ...
      <?=$this->form->create('',array('url'=>'#', 'enctype'=>"multipart/form-data")); ?>
						...
						<div class="list no-hairlines-md">
							<ul>
									...
									<li>
											<div class="text-editor text-edit-section text-editor-init" data-placeholder="Enter text..." data-buttons='[["bold", "italic", "underline", "strikeThrough"],["h1","h2","h3"],["alignLeft","alignRight","alignCenter","alignJustify"], ["subscript", "superscript"],
  ["indent", "outdent"], ["orderedList", "unorderedList"]]'>
